...
& $python3 aws-iot-device-sdk-python-v2\samples\mqtt\mqtt5_x509.py --endpoint a5zqrex595k8v-ats.iot.eu-west-1.amazonaws.com --cert unity-digital-twin-local.cert.pem --key unity-digital-twin-local.private.key --client_id basicPubSub --topic sdk/test/python --count 0